              ...
              <div className="p-5">
                ...
                <div className="mt-5 grid grid-cols-2 gap-3">
                  ...
                  <button
                    ...
                    disabled={loggingOut}
                    className="py-2.5 rounded-xl bg-brand-red text-white font-semibold hover:opacity-95 transition-opacity disabled:opacity-50 flex items-center justify-center gap-2"
                  >
                    {loggingOut ? (
                      <>
